        ...
        'items': [
          {
            ...
            'volumeInfo': {
              ...
              'description': 'Fundamentals of Biomechanics introduces the exciting world of how human movement is created and how it can ' +
              'be improved. Teachers, coaches and physical therapists all use biomechanics to help people improve movement and decrease ' +
              'the risk of injury. The book presents a comprehensive review of the major concepts of biomechanics and summarizes them in ' +
              'nine principles of biomechanics. Fundamentals of Biomechanics concludes by showing how these principles can be used by ' +
              'movement professionals to improve human movement. Specific case studies are presented in physical education, coaching, ' +
              ...
              'imageLinks': {
                'smallThumbnail': 'http://books.google.com/books/content?id=js2P_8lbR2wC&printsec=frontcover&img=1&zoom=5&edge=curl' +
                '&source=gbs_api',
                'thumbnail': 'http://books.google.com/books/content?id=js2P_8lbR2wC&printsec=frontcover&img=1&zoom=1&edge=curl' +
                '&source=gbs_api'
              },
              'language': 'en',
          ...
          },
          {
            ...
            'volumeInfo': {
              ...
              'publishedDate': '2005',
              'description': '\'Biomechanics of Sport and Exercise, Second Edition,\' introduces exercise and sport biomechanics in ' +
              'concise terms rather than focusing on complex math and physics. This book helps students learn to appreciate external ' +
              'forces and their effects, how the body generates forces to maintain position, and how forces create movement in physical ' +
              'activities.',
              'industryIdentifiers': [
                {
                  'type': 'ISBN_10',
  ...
  it('should return a single book when requested', fakeAsync(() => {
      const response = {
        ...
        'volumeInfo': {
          ...
          'publisher': 'Springer Science & Business Media',
          'publishedDate': '2003',
          'description': 'Fundamentals of Biomechanics introduces the exciting world of how human movement is created and how it can be ' +
          'improved. Teachers, coaches and physical therapists all use biomechanics to help people improve movement and decrease the ' +
          'risk of injury. The book presents a comprehensive review of the major concepts of biomechanics and summarizes them in nine ' +
          'principles of biomechanics. Fundamentals of Biomechanics concludes by showing how these principles can be used by movement ' +
          'professionals to improve human movement. Specific case studies are presented in physical education, coaching, strength and ' +
